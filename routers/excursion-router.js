...
router.get('/my-bills', authMiddleware, ExcursionController.getMyBills)
router.get('/my-bill', authMiddleware, ExcursionController.getMyBillById)
router.patch('/bill', authMiddleware, ExcursionController.updateBill)
router.post('/issue-invoices', authMiddleware, ExcursionController.issueInvoices)
